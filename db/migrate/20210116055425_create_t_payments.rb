class CreateTPayments < ActiveRecord::Migration[6.0]
  def change
    ...
    create_table :t_payments, id: false do |t|
      ...
      t.references :supplier_id, type: :string, limit: 6, null: false, foreign_key: {to_table: :m_suppliers, primary_key: :id} #支払先ID
      ...
      t.references :account_payable_id, type: :integer, null: false, foreign_key: {to_table: :t_account_payables, primary_key: :id} #買掛帳ID
