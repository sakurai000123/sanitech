class CreateTSalesDetails < ActiveRecord::Migration[6.0]
  def change
    ...
    create_table :t_sales_details do |t|
      ...
      t.references :sales_id, type: :integer, null: false, foreign_key: {to_table: :t_sales, primary_key: :id} #出荷ID
      t.integer :line_number, null: false #行番号
      t.integer :sort_number, null: false #ソート番号
      t.references :receive_order_detail_id, type: :integer, null: false, foreign_key: {to_table: :t_receive_order_details, primary_key: :id} #受注明細
